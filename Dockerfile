...
RUN composer config repositories.opehuone vcs https://github.com/City-of-Helsinki/opehuone2025 && \
    ...
    # helsinkiteema composer.json:
    # "require": {
	# 	"city-of-helsinki/wordpress-helfi-hds-wp": ">1.0"
    # }
    # assuming hds needs to be configured in this file too
    ...
    TablePress
    WP Mail SMTP - disabled in old document https://helsinkisolutionoffice.atlassian.net/wiki/spaces/KASKOWordP/pages/9022701808/Opehuone.fi#Plugins-in-use
    WPO365 | INTRANET - same as wpo-365-login-intranet?