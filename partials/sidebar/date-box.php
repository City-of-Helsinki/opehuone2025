...
<div class="sidebar-box date-box sidebar-box--suomenlinna-light">
    <div class="date-box-header">
        ...
        <span class="date-box-week"><?php echo esc_html( $week_number ) . '. viikko'; ?>
        <span class="separator">/</span>
        <span class="date-box-sv"><em>vecka</em></span></span>
    </div>

    <div class="date-box-content">
        <div class="date-box-grid">
            <div class="date-box-col date-box-days">
            ...
            <div class="date-box-col date-box-names-flags">
                <?php if ( ! empty( $finnish_names_list ) ): ?>
                    <span class="date-box-name-day-fi"><?php echo esc_html( implode( ', ', $finnish_names_list ) ); ?></span>
                <?php endif; ?>
                
                <?php if ( ! empty( $swedish_names_list ) ): ?>
                    <span class="date-box-name-day-sv"><em><?php echo esc_html( implode( ', ', $swedish_names_list ) ); ?></em></span>
                <?php endif; ?>

                <?php if ( ! empty( $day_info_service_data['flag_day'] ) ): ?>
                    <div class="date-box-flag-days">
                        <div>
                            <?php \Opehuone\Helpers\the_svg( 'icons/flag'); ?>
                        </div>
                        <div>
                            <span class="date-box-name-day-fi"><?php echo $day_info_service_data['flag_day']['fi']; ?></span>
                            <span class="date-box-name-day-sv date-box-sv"><em><?php echo $day_info_service_data['flag_day']['sv']; ?></em></span>
                        </div>
                    </div>
                <?php endif; ?>
            </div>
